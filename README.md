...
> 取得六角形架構開發規範
```
/fetch https://claude.ai/share/85859960-c545-4505-9eec-ca87138ac54e
```
> 取得三層式架構開發規範
```
/fetch https://claude.ai/share/df64f66a-271c-4e6c-a3f9-63a375124780
```
> 建立單一的六角形開發規範
```
...
> 按照不同層拆分不同開發規範
```
將 #file:copilot-instructions.md  與個分層對應的內容，搬移過去，只留下高階的開發規範 
```

##### 建議繼續添加：

- 修正 TaskId 和 Task 測試 : 解決編譯問題
- Domain Service 測試 : TaskDomainService, ProjectDomainService, TaskStatusDomainService, TaskViewDomainService
- Repository 適配器測試 : InMemoryTaskRepository, InMemoryProjectRepository
- CLI 適配器測試 : TaskListCLI
