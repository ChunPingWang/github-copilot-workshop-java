...
- **魔法打敗魔法，自己不想寫，請它寫**
  ...
  > prompt
   ```
   這是一個專門用於系統分析和設計的工具，重點在於使用 Mermaid 序列圖來視覺化系統流程
   所有圖表必須使用中文描述
   標準 Mermaid 語法
   遵循預定義的參與者命名規則
   ```
   ...
   在台新銀行提款機
   從中國信託轉帳500元到玉山銀行
   台新銀行透過財金公司，到中國信託與玉山銀行確兩邊認帳號是否存在
   中國信託回覆財金公司，帳號存在，再回覆給台新
   使用者輸入轉帳五百元
   台新銀行發送訊息給財金公司，轉知使用者要轉帳五百元
   財金公司發訊息給中國信託要從客戶扣款五百元加上手續費二十元
   財金公司發訊息給玉山銀行入帳五百元
   財金公司發訊息給台新銀行收到手續費二十元
   ```
